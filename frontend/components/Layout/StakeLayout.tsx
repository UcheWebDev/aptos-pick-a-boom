...
import LeftStakeSidebar from "./LeftStakeSidebar";
...
const Layout: React.FC<LayoutProps> = ({ children }) => {
  ...
  return (
    <div className="flex h-[100dvh] overflow-hidden bg-gray-50">
      {/* Mobile Navigation */}
      {!isDesktop && (
        <MobileNav isSidebarOpen={isSidebarOpen} onToggleSidebar={() => setIsSidebarOpen(!isSidebarOpen)} />
      )}
      ...
      `}
      >
        <LeftStakeSidebar onClose={() => setIsSidebarOpen(false)} />
      </div>
